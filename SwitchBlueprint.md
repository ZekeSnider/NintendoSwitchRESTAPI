...
`timestamp` is the current [unix (epoch) timestamp](https://www.epochconverter.com).
`requestId` is a generated [UUID version 4](https://www.uuidgenerator.net/version4).
